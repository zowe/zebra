...
export interface PostprocessorRequestParams extends RmfRequestParams {
  /**
   * This parameter specifies the date or date range of the reporting period for all Postprocessor reports.
   */
  date?:
    | Date
    | {
...
export interface IPostprocessor {
   ...
   */
  cache(params?: PostprocessorRequestParams): Promise<any>;
  /**
   ...
   */
  cf(params?: PostprocessorRequestParams): Promise<any>;
  /**
   ...
   */
  chan(params?: PostprocessorRequestParams): Promise<any>;
  /**
   ...
   */
  cpu(params?: PostprocessorRequestParams): Promise<any>;
  /**
   ...
   */
  crypto(params?: PostprocessorRequestParams): Promise<any>;
  /**
   ...
   */
  device(params?: PostprocessorRequestParams): Promise<any>;
  /**
   ...
   */
  eadm(params?: PostprocessorRequestParams): Promise<any>;
  /**
   ...
   */
  hfs(params?: PostprocessorRequestParams): Promise<any>;
  /**
   ...
   */
  ioq(params?: PostprocessorRequestParams): Promise<any>;
  /**
   ...
   */
  omvs(params?: PostprocessorRequestParams): Promise<any>;
  /**
   ...
   */
  pagesp(params?: PostprocessorRequestParams): Promise<any>;
  /**
   ...
   */
  paging(params?: PostprocessorRequestParams): Promise<any>;
  /**
   ...
   */
  sdelay(params?: PostprocessorRequestParams): Promise<any>;
  /**
   ...
   */
  vstor(params?: PostprocessorRequestParams): Promise<any>;
  /**
   ...
   */
  wlmgl(params?: PostprocessorRequestParams): Promise<any>;
  /**
   ...
   */
  xcf(params?: PostprocessorRequestParams): Promise<any>;
}
